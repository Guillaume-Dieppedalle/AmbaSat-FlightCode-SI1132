...
* AmbaSat-1 
* Filename: main.cpp
* AmbaSat-1 Flight Code for Sensor 06 - SI1132 UV, Visible and Infrared Light Sensor
* 27th February 2021
...
static const PROGMEM u1_t NWKSKEY[16] = {0x69,0x5D,0xE7,0x80,0x4D,0xF8,0x85,0x40,0x36,0x87,0x9A,0x1E,0xA9,0xFA,0x1E,0xC3};

// LoRaWAN AppSKey, application session key / DO NOT SHARE
static const u1_t PROGMEM APPSKEY[16] = {0x5B,0xC6,0x00,0xB5,0x6B,0x08,0xD5,0xD6,0xDE,0x0D,0x70,0x50,0x8F,0x20,0x31,0x9F};

// LoRaWAN end-device address (DevAddr) / DO NOT SHARE
static const u4_t DEVADDR = 0x26013DF4 ;
/********************************/
...
void loop()
{
   ...
   // **********************************************
    ...
    message.addUint16(ambasatSI1132->uv); 
    message.addUint16(ambasatSI1132->vis); 
    message.addUint16(ambasatSI1132->ir); 
    ...
    // send payload 
    ambasatLMIC->sendSensorPayload(SENSOR_06_SI1132, message);  
